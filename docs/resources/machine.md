...
a time, including resources managed with `for_each`. This option applies to both
control-plane and worker machines. Omitted or `false` preserves concurrent upgrades.
